...
public class KinesisStreamsSourceEnumeratorState {
    private final Set<String> completedShardIds;
    @Nullable private final String lastSeenShardId;

    public KinesisStreamsSourceEnumeratorState(
            Set<String> completedShardIds, String lastSeenShardId) {
        this.completedShardIds = completedShardIds;
        this.lastSeenShardId = lastSeenShardId;
    }

    public Set<String> getCompletedShardIds() {
        return completedShardIds;
    }
